...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row mb-3">
        ...
        <label class="col-sm-2 fw-bold">Ticket Status</label>
        <div class="col-sm-4">
            <p class="mb-0">{{ $ticket->ticketStatus->status ?? '-' }}</p>
        </div>
    </div>

    <!-- User -->
    <div class="row mb-3">
        <label class="col-sm-2 fw-bold">User Name</label>
        <div class="col-sm-4">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-4">
            <p class="mb-0">
                {{ $ticket->ticket_group == 'maintanance_group' ? 'Maintainance Group' : 
                   ($ticket->ticket_group == 'it_helpdesk' ? 'IT Helpdesk' : '-') }}
            </p>
        </div>
    </div>
